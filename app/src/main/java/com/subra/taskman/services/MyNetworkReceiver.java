...
public class MyNetworkReceiver extends BroadcastReceiver {
    ...
    */
    ...
    public MyNetworkReceiver(Context context) {
        ...
        this.snackbar = Snackbar.make(((Activity)context).findViewById(android.R.id.content), context.getString(R.string.msg_network_unavailable), Snackbar.LENGTH_INDEFINITE);
    }
